...
/**
 * PrevConsum generated by hbm2java
 */
@Entity
@Table(name="PREV_CONSUM"
    ,catalog="db_21511543"
)
public class PrevConsum  implements java.io.Serializable {


     private PrevConsumId id;
     private Vmi vmi;
    ...
    public PrevConsum(PrevConsumId id, Vmi vmi) {
        this.id = id;
        this.vmi = vmi;
    }
    public PrevConsum(PrevConsumId id, Vmi vmi, Integer quantity) {
       this.id = id;
       this.vmi = vmi;
    ...
    @AttributeOverrides( {
        @AttributeOverride(name="datePrevConsume", column=@Column(name="DATE_PREV_CONSUME", nullable=false, length=19) ), 
    ...
    public PrevConsumId getId() {
        return this.id;
    }
    
    public void setId(PrevConsumId id) {
        this.id = id;
    }
